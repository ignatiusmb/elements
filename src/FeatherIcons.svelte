<div style="display: none">
	...
	<svg>
		...
		<symbol id="arrow-left" viewBox="0 00 24 24">
			<line x1="19" y1="12" x2="5" y2="12" />
			<polyline points="12 19 5 12 12 5" />
		</symbol>

		<symbol id="arrow-right" viewBox="0 00 24 24">
			<line x1="5" y1="12" x2="19" y2="12" />
			<polyline points="12 5 19 12 12 19" />
		</symbol>

		<symbol id="arrow-up" viewBox="0 00 24 24">
		...
		<symbol id="chevron-right" viewBox="0 00 24 24">
			<polyline points="9 18 15 12 9 6" />
		</symbol>

		<symbol id="chevrons-left" viewBox="0 00 24 24">
			<polyline points="11 17 6 12 11 7" />
			<polyline points="18 17 13 12 18 7" />
		</symbol>

		<symbol id="chevrons-right" viewBox="0 00 24 24">
			<polyline points="13 17 18 12 13 7" />
			<polyline points="6 17 11 12 6 7" />
		</symbol>

		<symbol id="chevrons-up" viewBox="0 00 24 24">
			<polyline points="17 11 12 6 7 11" />
			<polyline points="17 18 12 13 7 18" />
		</symbol>

		<symbol id="close" viewBox="0 00 24 24">
			<line x1="18" y1="6" x2="6" y2="18" />
			<line x1="6" y1="6" x2="18" y2="18" />
		</symbol>

		<symbol id="copy" viewBox="0 00 24 24">
			<rect x="9" y="9" width="13" height="13" rx="2" ry="2" />
			<path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1" />
		</symbol>

		<symbol id="download" viewBox="0 00 24 24">
			<path d="M21 15V19A2 2 0 0 1 19 21H5A2 2 0 0 1 3 19V15" />
			<polyline points="7 10 12 15 17 10" />
			<line x1="12" y1="15" x2="12" y2="3" />
		</symbol>

		<symbol id="edit" viewBox="0 00 24 24">
			<path d="M20 14.66V20a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h5.34" />
			<polygon points="18 2 22 6 12 16 8 16 8 12 18 2" />
		</symbol>

		<symbol id="facebook" viewBox="0 00 24 24">
			<path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z" />
		</symbol>

		<symbol id="filter" viewBox="0 00 24 24">
			<polygon points="22 3 2 3 10 12.46 10 19 14 21 14 12.46 22 3" />
		</symbol>

		<symbol id="github" viewBox="0 00 24 24">
			<path
		...
		<symbol id="gitlab" viewBox="0 00 24 24">
			<path
				d="M22.65 14.39L12 22.13 1.35 14.39a.84.84 0 0 1-.3-.94l1.22-3.78 2.44-7.51A.42.42 0 0 1 4.82 2a.43.43 0 0 1 .58
				0 .42.42 0 0 1 .11.18l2.44 7.49h8.1l2.44-7.51A.42.42 0 0 1 18.6 2a.43.43 0 0 1 .58 0 .42.42 0 0 1 .11.18l2.44
				7.51L23 13.45a.84.84 0 0 1-.35.94z" />
		</symbol>

		<symbol id="git-branch" viewBox="0 00 24 24">
		...
		<symbol id="link" viewBox="0 00 24 24">
			<path d="M9,7L6,7A2 2 0 0 0 6,17L9,17" />
			<path d="M15,7L18,7A2 2 0 0 1 18,17L15,17" />
			<path d="M7,12L17,12" />
		</symbol>

		<symbol id="linkedin" viewBox="0 00 24 24">
			<path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z" />
			<rect x="2" y="9" width="4" height="12" />
			<circle cx="4" cy="4" r="2" />
		</symbol>

		<symbol id="log-in" viewBox="0 00 24 24">
		...
		<symbol id="maximize-2" viewBox="0 00 24 24">
		...
		<symbol id="menu" viewBox="0 00 24 24">
			<line x1="3" y1="12" x2="21" y2="12" />
			<line x1="3" y1="6" x2="21" y2="6" />
			<line x1="3" y1="18" x2="21" y2="18" />
		</symbol>

		<symbol id="message-square" viewBox="0 00 24 24">
			<path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z" />
		</symbol>

		<symbol id="mic" viewBox="0 00 24 24">
		...
		<symbol id="mic-off" viewBox="0 00 24 24">
			<line x1="1" y1="1" x2="23" y2="23" />
		...
		<symbol id="minus" viewBox="0 00 24 24">
			<line x1="5" y1="12" x2="19" y2="12" />
		</symbol>
		...
		<symbol id="share" viewBox="0 00 24 24">
			<path d="M4 12v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-8" />
			<polyline points="16 6 12 2 8 6" />
			<line x1="12" y1="2" x2="12" y2="15" />
		</symbol>

		<symbol id="sliders" viewBox="0 00 24 24">
		...
		<symbol id="twitter" viewBox="0 00 24 24">
			<path
		...
		<symbol id="youtube" viewBox="0 00 24 24">
			<path
				d="M22.54 6.42a2.78 2.78 0 0 0-1.94-2C18.88 4 12 4 12 4s-6.88 0-8.6.46a2.78 2.78 0 0 0-1.94 2A29 29 0 0 0 1
